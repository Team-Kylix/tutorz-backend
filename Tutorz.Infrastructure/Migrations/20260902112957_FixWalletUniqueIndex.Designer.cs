...
namespace Tutorz.Infrastructure.Migrations
{
    ...
    [Migration("20260902112957_FixWalletUniqueIndex")]
    partial class FixWalletUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tutorz.Domain.Entities.EarningsSummary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("ServerDeduction")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("SmsDeduction")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Tutorz.Domain.Entities.MonthlyPlatformCommissionSummary", b =>
                {
                    ...
                    b.Property<decimal>("PlatformAllCommission")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PlatformInstituteCommission")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PlatformTutorCommission")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("ClassId", "Month", "Year")
                        .IsUnique();

                    b.ToTable("MonthlyPlatformCommissionSummaries");
                });

            modelBuilder.Entity("Tutorz.Domain.Entities.MonthlyUsageSummary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tutorz.Domain.Entities.PreRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PreAllocatedRegNo")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<Guid>("PreAllocatedStudentId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("PreAllocatedUserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tutorz.Domain.Entities.SystemAnnouncement", b =>
                {
            ...
            modelBuilder.Entity("Tutorz.Domain.Entities.UserAnnouncementRead", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tutorz.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasIndex("UserId", "InstituteId", "IsIndividual")
                        .IsUnique()
            ...
            modelBuilder.Entity("Tutorz.Domain.Entities.SmsLog", b =>
                {
                    b.HasOne("Tutorz.Domain.Entities.User", "BilledUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Tutorz.Domain.Entities.UserAnnouncementRead", b =>
                {
                    b.HasOne("Tutorz.Domain.Entities.SystemAnnouncement", "Announcement")
                        .WithMany("UserReads")
