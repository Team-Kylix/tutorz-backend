...
{
    /// <inheritdoc />
    public partial class AddMonthlyBillAndWalletSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillNumber = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlyBills_BillNumber",
                table: "MonthlyBills",
                column: "BillNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MonthlyBills_UserId_Month_Year_IsIndividual",
                table: "MonthlyBills",
                columns: new[] { "UserId", "Month", "Year", "IsIndividual" },
                unique: true);
